...
[_QWERTY] = KEYMAP( \
  ...
  MT(MOD_LSFT, KC_Z), KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, \
                               KC_LCTL, LOWER,   KC_ENT,  KC_SPC,  RAISE,   TG(16)  \
),
...
[_RAISE] = KEYMAP( \
  ...
  KC_ESC,  KC_GRV,  KC_TILD, LSFT(KC_Z), KC_TAB,   KC_DELETE, _______, _______, _______,  _______,   \
...
[_LOWER] = KEYMAP( \
  ...
  KC_PIPE, KC_DQT , KC_UNDS,      KC_PLUS,      KC_LCBR, KC_RCBR, KC_4,    KC_5,    KC_6,    _______,    \
  KC_VOLD, KC_VOLU, KC_MUTE,      KC_LGUI,      KC_SCLN, KC_COLN, KC_1,    KC_2,    KC_3,    _______, \
                    _______,      _______,      _______, _______, _______, _______                           \
),
...
[_ADJUST] = KEYMAP( \
  ...
  RGB_TOG,      RGB_MOD,      RGB_HUI,      RGB_HUD,       _______, KC_WH_D,            KC_MS_L,       KC_MS_D,    KC_MS_R,    KC_WWW_REFRESH,         \
